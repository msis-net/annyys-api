...
public class Item {
    ...
    public String SendMail(
        ...
        String Param="request/download/"+mail+"/"+itemname;
        
        BodyMsg += "「"+itemname+"」ダウンロードのお申込みありがとうございます。\r\n";
        BodyMsg += "\r\n";
        BodyMsg += "\r\n";
        BodyMsg += "「"+itemname+"」は以下のURLからダウンロード可能です。（URLは24時間以内有効です。）\r\n";
        //BodyMsg += "\r\n【FileMakerV11対応】\r\n";
        ...
        Subject = "ANNYYS_D版ダウンロードリクエストがありました。";
        BodyMsg = "Name: "+name+"\r\n";
        BodyMsg += "Pref: "+pref+"\r\n";
